  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border-strong bg-transparent text-foreground hover:border-primary-bright hover:bg-primary/10",
        secondary: "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
        ghost: "hover:bg-accent/10 hover:text-foreground",
        link: "text-primary-bright underline-offset-4 hover:underline",
        /* AICO brand variants */
        hero: "bg-[image:var(--gradient-primary)] text-primary-foreground shadow-[var(--shadow-glow)] hover:brightness-115 hover:-translate-y-0.5",
        accent:
          "bg-accent text-accent-foreground shadow-[0_12px_40px_-16px_var(--accent)] hover:brightness-110 hover:-translate-y-0.5",
        glass:
          "surface-panel text-foreground backdrop-blur-md hover:border-border-strong hover:-translate-y-0.5",
